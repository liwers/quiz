...
angular.module('mean.quizzes').controller('QuizzesController', ['$scope', '$stateParams', '$location', 'Global', 'Quizzes', 'Questions', 'Alert', function ($scope, $stateParams, $location, Global, Quizzes, Questions, Alert) {
    $scope.global = Global;
    $scope.kinds = [
        {id: 'text', value: 'Texte'},
